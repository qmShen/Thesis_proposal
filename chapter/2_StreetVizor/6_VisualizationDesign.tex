...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.85\columnwidth]{fig5_statistic_view/statistic_view}
	\vspace{-4mm}
...
\begin{figure}[t] 
	\centering
	% \vspace{-4mm}
	\includegraphics[width=0.9\columnwidth]{fig6_street_map_view/street_map_view}
	\vspace{-3mm}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.9\columnwidth]{fig7_street_model/street_pcp}
	\vspace{-5mm}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.95\columnwidth]{fig8_study_1/study_1_spatial}
	\vspace{-4mm}
	\caption{
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\columnwidth]{fig8_study_1/study_1_statistic}
	\vspace{-7mm}
...
In addition to basic interactions in each view, StreetVizor also provides a control panel (Fig.~\ref{fig:teaser}(a)) that enables:
