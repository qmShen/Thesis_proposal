...
\subsection{Visualization of human movement}
As a general topic in visualization description, how to effectively visualizing the human movement has been long studied in recent years.  An overview has been proposed to categorized the existing movement visualization techniques into three classes: \textbf{pattern extraction}, \textbf{direct depiction}, \textbf{summarization} ~\cite{andrienko2013visual, wu2015telcovis}.
...
\subsection{Visualization of urban environment}. 



\subsection{Visual explanation for computing techniques}
