...
\depthead{Prof.~Dit-Yan~YEUNG}    % department head.
\defencedate{2019}{12}{17}      % \defencedate{year}{month}{day}.
...
%                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \input{chapter/_proof_reading_abstract_and_introduction_conclusion.tex}
% \input{chapter/_test_.tex}


\input{chapter/1_Introduction.tex}
\input{chapter/2_StreetVizor/0_streetvizor.tex}
\input{chapter/3_edgebundling/0_edgebundling.tex}
\input{chapter/4_MultiRNNExplorer/0_MultiRNNExplorer.tex}
\input{chapter/4_Conclusion.tex}
